...
for genres in topGenres:    
    ...
    percents.append((genres[1]/500)*100)


plt.bar(labels,percents)
plt.title("most common genres among Best 500 books")
plt.ylabel("percentage of books")
plt.tight_layout()
plt.xticks(rotation='vertical')
plt.savefig("E:/Ramya/brushUps/Basics/CASE_STUDIES/GOOD_READS/Data_Analysis/AnalysisPlots/topGenresBestBooks",bbox_inches='tight')
plt.show()

with open("E:/Ramya/brushUps/Basics/CASE_STUDIES/GOOD_READS/Data_Analysis/top15GenresBestBooks.csv",'w',newline="") as wf:
    wf.write('genres')
    wf.write("\n")
    for genre in labels:
        wf.write(genre)
